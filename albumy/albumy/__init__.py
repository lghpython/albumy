...
from albumy.extensions import db, csrf, bootstrap, login_manager, mail, moment, avatars, whooshee, dropzone
from albumy.settings import config
from albumy.models import Role, User, Photo, Comment, Collect, Follow, Tag, Notification
